...
public class RepositoryTest {
  ...
  @Test
  void testInsert() {
    Comment comment = new Comment("aidil@test.com", "hi");
  ...
  @Test
  void testFindById() {
    Comment comment = commentRepository.findById(101);
  ...
  void testFindByEmail() {
    List<Comment> comments = commentRepository.findAllByEmail("aidil@test.com");
    System.out.println(comments.size());
  }
}
